...
contract CoinPoolToken is IERC20 {

    string public name = "CoinPoolToken";
  ...
  constructor(uint256 total, string memory _name, string memory _symbol) public {
    ...
    function transferFrom(address owner, address buyer, uint256 numTokens) public override returns (bool) {
        require(numTokens <= balances[owner], "Insufficient funds");
        require(numTokens <= allowed[owner][msg.sender], "Insufficient allowed funds");
